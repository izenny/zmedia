            ...
            <div className="signup-box">
                ...
                <div>
                    ...
                    <div className="signup-input-box">
                        <input type="text" className='input-signup' required value={Firstname} onChange={(e)=>{setFirstname(e.target.value)}}/>
                        <label className='label-signup'>Firstname</label>
                    </div>
                    <div className="signup-input-box">
                        <input type="text" className='input-signup' required value={Lastname} onChange={(e)=>{setLastname(e.target.value)}}/>
                        <label className='label-signup'>Lastname</label>
                    </div>
                    <div className="signup-input-box">
                        <input type="email" className='input-signup' required value={Email} onChange={(e)=>{setEmail(e.target.value)}}/>
                    ...
                    <div className="signup-input-box">
                        <input type="password" className='input-signup' required value={Password} onChange={(e)=>{setPassword(e.target.value)}}/>
